...
var wsPlayerStr = JSON.stringify(wsPlayer);
localStorage.setItem("wsPlayer",wsPlayerStr);

var getDataStr = JSON.parse(localStorage.getItem("wsPlayer"));
console.log(getDataStr[0].Speler);

var numArray = [0,1,2,3,4];
var numArrayStr = JSON.stringify(numArray);
localStorage.setItem("numArray",numArrayStr);
getDataStr = JSON.parse(localStorage.getItem("numArray"));
console.log(getDataStr[3]);
    ...
    switch(selectItem){
        ...
        case 2:
            ...
            for ( var i=0; i < objAll.length; i++){
                ...
                pageString+="<tr><td>"+objAll[i].Country+"</td><td>"+objAll[i].Count+"</td></tr>";
            }
