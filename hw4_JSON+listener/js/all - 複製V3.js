...
document.getElementById("submutBtn").onclick = function(){
    ...
    switch(selectItem){
        ...
        for ( var i=1; i < wsPlayer.length; i++){
            ...
            document.write("<table class=\"diffTable\" style=\"border-bottom: 1px solid #000\"><tr><td>"+wsPlayer[i].Speler+" 跟 "+wsPlayer[0].Speler+" 差距： "+"</td><td>"+diffScore+" 分</td></tr></table>");
        ...
        case 2:
            ...
            for ( var i=0; i < objAll.length; i++){
                console.log("------");
                console.log("objAll: "+objAll[i].Country+" "+objAll[i].Count);
                document.write("<table style=\"border-bottom: 1px solid #000\"><tr><td>"+objAll[i].Country+"</td><td>"+objAll[i].Count+" 人</td></tr></table>");
            }
            break;
        case 3:
